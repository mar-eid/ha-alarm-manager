 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,A=t=>t,C=w.trustedTypes,k=C?C.createPolicy("lit-html",{createHTML:t=>t}):void 0,E="$lit$",S=`lit$${Math.random().toFixed(9).slice(2)}$`,T="?"+S,P=`<${T}>`,M=document,N=()=>M.createComment(""),L=t=>null===t||"object"!=typeof t&&"function"!=typeof t,H=Array.isArray,V="[ \t\n\f\r]",z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,I=/-->/g,U=/>/g,O=RegExp(`>|${V}(?:([^\\s"'>=/]+)(${V}*=${V}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),D=/'/g,R=/"/g,q=/^(?:script|style|textarea|title)$/i,F=(t=>(e,...i)=>({_$litType$:t,strings:e,values:i}))(1),j=Symbol.for("lit-noChange"),B=Symbol.for("lit-nothing"),Z=new WeakMap,W=M.createTreeWalker(M,129);function K(t,e){if(!H(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(e):e}const Y=(t,e)=>{const i=t.length-1,a=[];let s,r=2===e?"<svg>":3===e?"<math>":"",o=z;for(let e=0;e<i;e++){const i=t[e];let n,l,d=-1,c=0;for(;c<i.length&&(o.lastIndex=c,l=o.exec(i),null!==l);)c=o.lastIndex,o===z?"!--"===l[1]?o=I:void 0!==l[1]?o=U:void 0!==l[2]?(q.test(l[2])&&(s=RegExp("</"+l[2],"g")),o=O):void 0!==l[3]&&(o=O):o===O?">"===l[0]?(o=s??z,d=-1):void 0===l[1]?d=-2:(d=o.lastIndex-l[2].length,n=l[1],o=void 0===l[3]?O:'"'===l[3]?R:D):o===R||o===D?o=O:o===I||o===U?o=z:(o=O,s=void 0);const h=o===O&&t[e+1].startsWith("/>")?" ":"";r+=o===z?i+P:d>=0?(a.push(n),i.slice(0,d)+E+i.slice(d)+S+h):i+S+(-2===d?e:h)}return[K(t,r+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),a]};class J{constructor({strings:t,_$litType$:e},i){let a;this.parts=[];let s=0,r=0;const o=t.length-1,n=this.parts,[l,d]=Y(t,e);if(this.el=J.createElement(l,i),W.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(a=W.nextNode())&&n.length<o;){if(1===a.nodeType){if(a.hasAttributes())for(const t of a.getAttributeNames())if(t.endsWith(E)){const e=d[r++],i=a.getAttribute(t).split(S),o=/([.?@])?(.*)/.exec(e);n.push({type:1,index:s,name:o[2],strings:i,ctor:"."===o[1]?et:"?"===o[1]?it:"@"===o[1]?at:tt}),a.removeAttribute(t)}else t.startsWith(S)&&(n.push({type:6,index:s}),a.removeAttribute(t));if(q.test(a.tagName)){const t=a.textContent.split(S),e=t.length-1;if(e>0){a.textContent=C?C.emptyScript:"";for(let i=0;i<e;i++)a.append(t[i],N()),W.nextNode(),n.push({type:2,index:++s});a.append(t[e],N())}}}else if(8===a.nodeType)if(a.data===T)n.push({type:2,index:s});else{let t=-1;for(;-1!==(t=a.data.indexOf(S,t+1));)n.push({type:7,index:s}),t+=S.length-1}s++}}static createElement(t,e){const i=M.createElement("template");return i.innerHTML=t,i}}function G(t,e,i=t,a){if(e===j)return e;let s=void 0!==a?i._$Co?.[a]:i._$Cl;const r=L(e)?void 0:e._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),void 0===r?s=void 0:(s=new r(t),s._$AT(t,i,a)),void 0!==a?(i._$Co??=[])[a]=s:i._$Cl=s),void 0!==s&&(e=G(t,s._$AS(t,e.values),s,a)),e}class Q{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,a=(t?.creationScope??M).importNode(e,!0);W.currentNode=a;let s=W.nextNode(),r=0,o=0,n=i[0];for(;void 0!==n;){if(r===n.index){let e;2===n.type?e=new X(s,s.nextSibling,this,t):1===n.type?e=new n.ctor(s,n.name,n.strings,this,t):6===n.type&&(e=new st(s,this,t)),this._$AV.push(e),n=i[++o]}r!==n?.index&&(s=W.nextNode(),r++)}return W.currentNode=M,a}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,a){this.type=2,this._$AH=B,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=G(this,t,e),L(t)?t===B||null==t||""===t?(this._$AH!==B&&this._$AR(),this._$AH=B):t!==this._$AH&&t!==j&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>H(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==B&&L(this._$AH)?this._$AA.nextSibling.data=t:this.T(M.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,a="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=J.createElement(K(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===a)this._$AH.p(e);else{const t=new Q(a,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=Z.get(t.strings);return void 0===e&&Z.set(t.strings,e=new J(t)),e}k(t){H(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,a=0;for(const s of t)a===e.length?e.push(i=new X(this.O(N()),this.O(N()),this,this.options)):i=e[a],i._$AI(s),a++;a<e.length&&(this._$AR(i&&i._$AB.nextSibling,a),e.length=a)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=A(t).nextSibling;A(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class tt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,a,s){this.type=1,this._$AH=B,this._$AN=void 0,this.element=t,this.name=e,this._$AM=a,this.options=s,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=B}_$AI(t,e=this,i,a){const s=this.strings;let r=!1;if(void 0===s)t=G(this,t,e,0),r=!L(t)||t!==this._$AH&&t!==j,r&&(this._$AH=t);else{const a=t;let o,n;for(t=s[0],o=0;o<s.length-1;o++)n=G(this,a[i+o],e,o),n===j&&(n=this._$AH[o]),r||=!L(n)||n!==this._$AH[o],n===B?t=B:t!==B&&(t+=(n??"")+s[o+1]),this._$AH[o]=n}r&&!a&&this.j(t)}j(t){t===B?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class et extends tt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===B?void 0:t}}class it extends tt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==B)}}class at extends tt{constructor(t,e,i,a,s){super(t,e,i,a,s),this.type=5}_$AI(t,e=this){if((t=G(this,t,e,0)??B)===j)return;const i=this._$AH,a=t===B&&i!==B||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==B&&(i===B||a);a&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class st{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){G(this,t)}}const rt=w.litHtmlPolyfillSupport;rt?.(J,X),(w.litHtmlVersions??=[]).push("3.3.3");const ot=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class nt extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const a=i?.renderBefore??e;let s=a._$litPart$;if(void 0===s){const t=i?.renderBefore??null;a._$litPart$=s=new X(e.insertBefore(N(),t),t,void 0,i??{})}return s._$AI(t),s})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return j}}nt._$litElement$=!0,nt.finalized=!0,ot.litElementHydrateSupport?.({LitElement:nt});const lt=ot.litElementPolyfillSupport;lt?.({LitElement:nt}),(ot.litElementVersions??=[]).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return pt({...t,state:!0,attribute:!1})}const gt=o`
  :host {
...
`,vt=t=>({0:"#2196F3",1:"#FF9800",2:"#FF5722",3:"#F44336"}[t]??"#9E9E9E"),_t=t=>({normal:"#4CAF50",active_unacknowledged:"#F44336",active_acknowledged:"#FF9800",returned_to_normal_unacknowledged:"#FF9800",shelved:"#9C27B0",disabled:"#9E9E9E"}[t]??"#9E9E9E"),mt=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/list"})).alarms,ft=async(t,e,i)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/shelve",alarm_id:e,duration:i})},bt=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/channel/list"})).channels,yt=async(t,e={})=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/event/list",...e})).events,$t={0:"Info",1:"Warning",2:"High",3:"Critical"},xt={normal:"Normal",active_unacknowledged:"Active (Unacked)",active_acknowledged:"Active (Acked)",returned_to_normal_unacknowledged:"RTN (Unacked)",shelved:"Shelved",disabled:"Disabled"};let wt=class extends nt{constructor(){super(...arguments),this.priority=0}static{this.styles=o`
    .badge {
      display: inline-block;
      padding: 2px 8px;
      border-radius: 12px;
  ...
  `}render(){const t=vt(this.priority),e=$t[this.priority]??"Unknown";return F`
      <span class="badge" style="background-color: ${t}">${e}</span>
    `}};t([pt({type:Number})],wt.prototype,"priority",void 0),wt=t([dt("severity-badge")],wt);let At=class extends nt{constructor(){super(...arguments),this.open=!1}static{this.styles=[gt,o`
      .overlay {
          ...
          <div class="dialog-body">
            ...
            <div class="section">
              ...
              <div class="field">
                ...
                <span class="field-value"><span class="badge" style="background: ${_t(e.state)}">${xt[e.state]??e.state}</span></span>
              </div>
              <div class="field">
            ...
            <div class="section">
              ...
              <div class="field">
                ...
                <span class="field-value">${$t[t.priority]}</span>
              </div>
              <div class="field">
    ...
    `}};t([pt({attribute:!1})],At.prototype,"alarm",void 0),t([pt({type:Boolean})],At.prototype,"open",void 0),At=t([dt("alarm-detail-dialog")],At);var Ct="M17,19H7V5H17M17,1H7C5.89,1 5,1.89 5,3V21A2,2 0 0,0 7,23H17A2,2 0 0,0 19,21V3C19,1.89 18.1,1 17,1Z",kt="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z";const Et="#9c27b0",St=[15,30,60,240,480];let Tt=class extends nt{constructor(){super(...arguments),this.open=!1,this.alarmId="",this.alarmName="",this._minutes=15}static{this.styles=[gt,o`
      .overlay {
        position: fixed;
        inset: 0;
        z-index: 1000;
      ...
      .chip.sel {
        border-color: ${Et};
        background: color-mix(in srgb, ${Et} 14%, transparent);
        color: ${Et};
      }
      .slider {
        display: flex;
    ...
    `:F``}};t([pt({type:Boolean})],Tt.prototype,"open",void 0),t([pt()],Tt.prototype,"alarmId",void 0),t([pt()],Tt.prototype,"alarmName",void 0),t([ut()],Tt.prototype,"_minutes",void 0),Tt=t([dt("shelve-dialog")],Tt);let Pt=class extends nt{constructor(){super(...arguments),this.priorityFilter="",this._alarms=[],this._loading=!0,this._filterPriority="",this._filterName="",this._filterState="",this._filterSource=""}static{this.styles=[gt,o`
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadAlarms(),this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.()}async _loadAlarms(){if(this.hass)try{const t=await mt(this.hass);this._alarms=t.filter(t=>"active_unacknowledged"===t.runtime.state||"active_acknowledged"===t.runtime.state||"returned_to_normal_unacknowledged"===t.runtime.state)}finally{this._loading=!1}}async _subscribe(){this.hass&&(this._unsub=await(async(t,e)=>t.connection.subscribeMessage(e,{type:"scada_alarm_manager/subscribe"}))(this.hass,()=>{this._loadAlarms()}))}get _filtered(){const t=this.priorityFilter||this._filterPriority;return this._alarms.filter(e=>(!t||String(e.priority)===t)&&(!(this._filterName&&!e.name.toLowerCase().includes(this._filterName.toLowerCase()))&&((!this._filterState||e.runtime.state===this._filterState)&&!(this._filterSource&&!e.source_entity_id.toLowerCase().includes(this._filterSource.toLowerCase()))))).sort((t,e)=>e.priority-t.priority)}async _ack(t){this.hass&&(await(async(t,e)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/acknowledge",alarm_id:e})})(this.hass,t),this._loadAlarms())}_shelve(t){this._shelveTarget=t}render(){if(this._loading)return F`<div class="empty-state">Loading...</div>`;if(0===this._alarms.length)return F`
          ...
          <tr class="filter-row">
            ...
            <th>
              <select @change=${t=>this._filterState=t.target.value}>
                <option value="">All</option>
                ${["active_unacknowledged","active_acknowledged","returned_to_normal_unacknowledged"].map(t=>F`<option value=${t}>${xt[t]}</option>`)}
              </select>
            </th>
        ...
        <tbody>
          ${t.map(t=>{const e=t.priority>=3?"alarm-row-critical":t.priority>=2?"alarm-row-high":"",i="active_unacknowledged"===t.runtime.state||"returned_to_normal_unacknowledged"===t.runtime.state;return F`
              <tr class="${e} ${t.priority>=3&&i?"flashing":""}" @click=${()=>this._detailAlarm=t}>
                ...
                <td><span class="badge" style="background: ${_t(t.runtime.state)}">${xt[t.runtime.state]??t.runtime.state}</span></td>
                ...
                <td class="actions">
                  ${i?F`<button class="btn btn-primary btn-small" @click=${e=>{e.stopPropagation(),this._ack(t.id)}}>ACK</button>`:""}
      ...
      <shelve-dialog
        ...
        @shelve-confirm=${async t=>{await ft(this.hass,t.detail.alarmId,t.detail.minutes),this._shelveTarget=void 0,this._loadAlarms()}}
      ></shelve-dialog>
    `}};t([pt({attribute:!1})],Pt.prototype,"hass",void 0),t([pt()],Pt.prototype,"priorityFilter",void 0),t([ut()],Pt.prototype,"_alarms",void 0),t([ut()],Pt.prototype,"_loading",void 0),t([ut()],Pt.prototype,"_detailAlarm",void 0),t([ut()],Pt.prototype,"_shelveTarget",void 0),t([ut()],Pt.prototype,"_filterPriority",void 0),t([ut()],Pt.prototype,"_filterName",void 0),t([ut()],Pt.prototype,"_filterState",void 0),t([ut()],Pt.prototype,"_filterSource",void 0),Pt=t([dt("active-alarms-view")],Pt);let Mt=class extends nt{constructor(){super(...arguments),this.priorityFilter="",this._alarms=[],this._channels=[],this._loading=!0,this._filterPriority="",this._filterName="",this._filterState="",this._filterEntity="",this._filterTrigger="",this._filterChannel="",this._filterEnabled=""}static{this.styles=[gt,o`
      :host { display: block; padding: 16px; }
    ...
    `]}connectedCallback(){super.connectedCallback(),this._load()}async _load(){if(this.hass)try{const[t,e]=await Promise.all([mt(this.hass),bt(this.hass)]);this._alarms=t,this._channels=e}finally{this._loading=!1}}_getChannelName(t){if(!t)return"-";const e=this._channels.find(e=>e.id===t);return e?e.name:t}get _filtered(){const t=this.priorityFilter||this._filterPriority;return this._alarms.filter(e=>{if(t&&String(e.priority)!==t)return!1;if(this._filterName&&!e.name.toLowerCase().includes(this._filterName.toLowerCase()))return!1;if(this._filterState&&e.runtime.state!==this._filterState)return!1;if(this._filterEntity&&!e.source_entity_id.toLowerCase().includes(this._filterEntity.toLowerCase()))return!1;if(this._filterTrigger&&e.trigger_type!==this._filterTrigger)return!1;if(this._filterChannel){if(!this._getChannelName(e.channel_id).toLowerCase().includes(this._filterChannel.toLowerCase()))return!1}return!("yes"===this._filterEnabled&&!e.enabled)&&("no"!==this._filterEnabled||!e.enabled)})}async _delete(t){this.hass&&confirm("Delete this alarm?")&&(await(async(t,e)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/delete",alarm_id:e})})(this.hass,t),this._load())}_edit(t){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:"create-edit",alarmId:t},bubbles:!0,composed:!0}))}async _testNotification(t){this.hass&&t.channel_id&&await this.hass.callService("scada_alarm_manager","test_notification",{channel_id:t.channel_id})}_shelve(t){this._shelveTarget=t}async _unshelve(t){this.hass&&(await(async(t,e)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/unshelve",alarm_id:e})})(this.hass,t),this._load())}render(){if(this._loading)return F`<div class="empty-state">Loading...</div>`;const t=this._filtered;return F`
        ...
        <thead>
          ...
          <tr class="filter-row">
            ...
            <th>
              <select @change=${t=>this._filterState=t.target.value}>
                <option value="">All</option>
                ${Object.entries(xt).map(([t,e])=>F`<option value=${t}>${e}</option>`)}
              </select>
            </th>
      ...
      <shelve-dialog
        ...
        .alarmName=${this._shelveTarget?.name??""}
        @dialog-closed=${()=>this._shelveTarget=void 0}
        @shelve-confirm=${async t=>{await ft(this.hass,t.detail.alarmId,t.detail.minutes),this._shelveTarget=void 0,this._load()}}
      ></shelve-dialog>
    `}};t([pt({attribute:!1})],Mt.prototype,"hass",void 0),t([pt()],Mt.prototype,"priorityFilter",void 0),t([ut()],Mt.prototype,"_alarms",void 0),t([ut()],Mt.prototype,"_channels",void 0),t([ut()],Mt.prototype,"_loading",void 0),t([ut()],Mt.prototype,"_detailAlarm",void 0),t([ut()],Mt.prototype,"_shelveTarget",void 0),t([ut()],Mt.prototype,"_filterPriority",void 0),t([ut()],Mt.prototype,"_filterName",void 0),t([ut()],Mt.prototype,"_filterState",void 0),t([ut()],Mt.prototype,"_filterEntity",void 0),t([ut()],Mt.prototype,"_filterTrigger",void 0),t([ut()],Mt.prototype,"_filterChannel",void 0),t([ut()],Mt.prototype,"_filterEnabled",void 0),Mt=t([dt("all-alarms-view")],Mt);let Nt=class extends nt{constructor(){super(...arguments),this._events=[],this._loading=!0,this._offset=0,this._limit=50,this._filterAlarm="",this._filterEvent="",this._filterUser=""}static{this.styles=[gt,o`
      :host { display: block; padding: 16px; }
        ...
        <tbody>
          ${e.map(t=>F`
              <tr>
                ...
                <td>${t.old_state?F`<span class="badge" style="background: ${_t(t.old_state)}">${xt[t.old_state]??t.old_state}</span>`:"-"}</td>
                <td>${t.new_state?F`<span class="badge" style="background: ${_t(t.new_state)}">${xt[t.new_state]??t.new_state}</span>`:"-"}</td>
                <td>${t.user??"-"}</td>
              </tr>
            `)}
        </tbody>
    ...
    `]}connectedCallback(){super.connectedCallback(),this._onDoc=this._onDoc.bind(this),document.addEventListener("mousedown",this._onDoc)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._onDoc)}_onDoc(t){t.composedPath().includes(this)||(this._open=!1)}_meta(t){return this.targets.find(e=>e.id===t)??{id:t,label:t,path:"M10 21H14C14 22.1 13.1 23 12 23S10 22.1 10 21M21 19V20H3V19L5 17V11C5 7.9 7 5.2 10 4.3V4C10 2.9 10.9 2 12 2S14 2.9 14 4V4.3C17 5.2 19 7.9 19 11V17L21 19M17 11C17 8.2 14.8 6 12 6S7 8.2 7 11V18H17V11Z"}}_emit(t){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t}}))}_add(t){this._emit([...this.value,t])}_remove(t){this._emit(this.value.filter(e=>e!==t))}render(){const t=this.targets.filter(t=>!this.value.includes(t.id));return F`
      <div class="box">
        ...
        ${this.value.map(t=>{const e=this._meta(t);return F`
            <span class="chip">
      ...
      ${this._open&&t.length>0?F`
          ...
          `:B}
    `}};t([pt({attribute:!1})],Ht.prototype,"value",void 0),t([pt({attribute:!1})],Ht.prototype,"targets",void 0),t([ut()],Ht.prototype,"_open",void 0),Ht=t([dt("notify-target-picker")],Ht);let Vt=class extends nt{constructor(){super(...arguments),this._channels=[],this._loading=!0,this._editing=null,this._formName="",this._formTargets=[],this._formMinPriority=0,this._formPersistent=!0,this._formMobile=!0,this._formCritical=!1,this._filterName=""}static{this.styles=[gt,o`
      :host { display: block; padding: 16px; }
      .form-card {
        background: var(--card-background-color, white);
        border: 1px solid var(--divider-color, #e0e0e0);
    ...
    `}};t([pt({attribute:!1})],zt.prototype,"hass",void 0),t([pt()],zt.prototype,"alarmId",void 0),t([ut()],zt.prototype,"_channels",void 0),t([ut()],zt.prototype,"_loading",void 0),t([ut()],zt.prototype,"_saving",void 0),t([ut()],zt.prototype,"_name",void 0),t([ut()],zt.prototype,"_description",void 0),t([ut()],zt.prototype,"_sourceEntityId",void 0),t([ut()],zt.prototype,"_triggerType",void 0),t([ut()],zt.prototype,"_priority",void 0),t([ut()],zt.prototype,"_area",void 0),t([ut()],zt.prototype,"_equipment",void 0),t([ut()],zt.prototype,"_tag",void 0),t([ut()],zt.prototype,"_channelId",void 0),t([ut()],zt.prototype,"_enabled",void 0),t([ut()],zt.prototype,"_latching",void 0),t([ut()],zt.prototype,"_ackRequired",void 0),t([ut()],zt.prototype,"_autoClear",void 0),t([ut()],zt.prototype,"_analogOperator",void 0),t([ut()],zt.prototype,"_analogThreshold",void 0),t([ut()],zt.prototype,"_digitalTargetState",void 0),t([ut()],zt.prototype,"_customMatchValues",void 0),zt=t([dt("create-edit-view")],zt);let It=class extends nt{constructor(){super(...arguments),this._alarmCount=0,this._channelCount=0,this._eventCount=0,this._loading=!0}static{this.styles=[gt,o`
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadStats()}async _loadStats(){if(this.hass)try{const[t,e,i]=await Promise.all([mt(this.hass),bt(this.hass),yt(this.hass,{limit:1})]);this._alarmCount=t.length,this._channelCount=e.length,this._eventCount=i.length>0?-1:0}finally{this._loading=!1}}render(){return this._loading?F`<div class="empty-state">Loading...</div>`:F`
    ...
    `}};t([pt({attribute:!1})],It.prototype,"hass",void 0),t([ut()],It.prototype,"_alarmCount",void 0),t([ut()],It.prototype,"_channelCount",void 0),t([ut()],It.prototype,"_eventCount",void 0),t([ut()],It.prototype,"_loading",void 0),It=t([dt("settings-view")],It);const Ut=[{id:"active",label:"Active Alarms"},{id:"all",label:"All Alarms"},{id:"history",label:"History"},{id:"channels",label:"Channels"},{id:"create-edit",label:"Create / Edit"},{id:"settings",label:"Settings"}];let Ot=class extends nt{constructor(){super(...arguments),this._config={type:"custom:scada-alarm-center-card"},this._activeTab="active",this._handleNavigate=t=>{const{view:e,alarmId:i}=t.detail;this._activeTab=e,this._editAlarmId=i}}static{this.styles=[gt,o`
      :host { display: block; }
    ...
    `]}setConfig(t){this._config=t,t.default_tab&&(this._activeTab=t.default_tab)}static getConfigElement(){}static getStubConfig(){return{type:"custom:scada-alarm-center-card",title:"Alarm Center"}}connectedCallback(){super.connectedCallback(),this.addEventListener("navigate",this._handleNavigate)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("navigate",this._handleNavigate)}_setTab(t){this._activeTab=t,"create-edit"!==t&&(this._editAlarmId=void 0)}getCardSize(){return 8}render(){return F`
      <ha-card>
    ...
    `}_renderView(){switch(this._activeTab){case"active":default:return F`<active-alarms-view .hass=${this.hass}></active-alarms-view>`;case"all":return F`<all-alarms-view .hass=${this.hass}></all-alarms-view>`;case"history":return F`<history-view .hass=${this.hass}></history-view>`;case"channels":return F`<channels-view .hass=${this.hass}></channels-view>`;case"create-edit":return F`<create-edit-view .hass=${this.hass} .alarmId=${this._editAlarmId??""}></create-edit-view>`;case"settings":return F`<settings-view .hass=${this.hass}></settings-view>`}}};t([pt({attribute:!1})],Ot.prototype,"hass",void 0),t([ut()],Ot.prototype,"_config",void 0),t([ut()],Ot.prototype,"_activeTab",void 0),t([ut()],Ot.prototype,"_editAlarmId",void 0),Ot=t([dt("scada-alarm-center-card")],Ot);const Dt=window.customCards||[];Dt.push({type:"scada-alarm-center-card",name:"SCADA Alarm Center",description:"Full Alarm Center with tabs — use in panel mode for fullscreen",preview:!1}),window.customCards=Dt;export{Ot as ScadaAlarmCenterCard};
