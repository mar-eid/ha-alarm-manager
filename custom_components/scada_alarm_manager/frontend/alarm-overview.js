...
`,kt=t=>({0:"#2196F3",1:"#FF9800",2:"#FF5722",3:"#F44336"}[t]??"#9E9E9E"),Ct=t=>({normal:"#4CAF50",active_unacknowledged:"#F44336",active_acknowledged:"#FF9800",returned_to_normal_unacknowledged:"#FF9800",shelved:"#9C27B0",disabled:"#9E9E9E"}[t]??"#9E9E9E"),At=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/list"})).alarms,Et=async(t,e,i)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/shelve",alarm_id:e,duration:i})},Mt=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/channel/list"})).channels,Lt=async(t,e)=>t.connection.subscribeMessage(e,{type:"scada_alarm_manager/subscribe"}),St={0:"Info",1:"Warning",2:"High",3:"Critical"},Tt={normal:"Normal",active_unacknowledged:"Active (Unacked)",active_acknowledged:"Active (Acked)",returned_to_normal_unacknowledged:"RTN (Unacked)",shelved:"Shelved",disabled:"Disabled"},Ht=["active_unacknowledged","active_acknowledged","returned_to_normal_unacknowledged"],Pt=["active_unacknowledged","returned_to_normal_unacknowledged"],Vt=[3,2,1,0],zt={0:$t,1:vt,2:_t,3:mt};let Nt=class extends lt{constructor(){super(...arguments),this.alarms=[],this.filterPriority=""}static{this.styles=[wt,n`
    ...
    `}render(){const t=this.alarms.filter(t=>Ht.includes(t.runtime.state)),e=e=>t.filter(t=>t.priority===e).length,i=t.filter(t=>Pt.includes(t.runtime.state)).length,a=this.alarms.filter(t=>"shelved"===t.runtime.state).length,s=t.length,o=Vt.map(t=>({p:t,n:e(t)})).filter(t=>t.n>0);return q`
      <div class="kpis">
        ...
        ${Vt.map(t=>this._tile(kt(t),e(t),St[t],zt[t],String(t)))}
      ...
      ${s>0?q`
          ...
          `:B}
    `}};t([ut({attribute:!1})],Nt.prototype,"alarms",void 0),t([ut()],Nt.prototype,"filterPriority",void 0),Nt=t([ct("alarm-kpi-strip")],Nt);const It={0:$t,1:vt,2:_t,3:mt};let Ut=class extends lt{constructor(){super(...arguments),this.priority=0}static{this.styles=n`
    .badge {
      display: inline-flex;
      align-items: center;
      justify-content: center;
  ...
  `}render(){const t=kt(this.priority),e=St[this.priority]??"Unknown";return q`
      <span
        class="badge"
          ...
          <div class="dialog-body">
            ...
            <div class="section">
              ...
              <div class="field">
                ...
                <span class="field-value"><span class="badge" style="background: ${Ct(e.state)}">${Tt[e.state]??e.state}</span></span>
              </div>
              <div class="field">
    ...
    `}};t([ut({attribute:!1})],Ot.prototype,"alarm",void 0),t([ut({type:Boolean})],Ot.prototype,"open",void 0),Ot=t([ct("alarm-detail-dialog")],Ot);const Dt=r("#9c27b0"),Rt=[15,30,60,240,480];let jt=class extends lt{constructor(){super(...arguments),this.open=!1,this.alarmId="",this.alarmName="",this._minutes=15}static{this.styles=[wt,n`
      .overlay {
        position: fixed;
        inset: 0;
        z-index: 1000;
    ...
    `:q``}};t([ut({type:Boolean})],jt.prototype,"open",void 0),t([ut()],jt.prototype,"alarmId",void 0),t([ut()],jt.prototype,"alarmName",void 0),t([gt()],jt.prototype,"_minutes",void 0),jt=t([ct("shelve-dialog")],jt);const Ft=["active_unacknowledged","returned_to_normal_unacknowledged"];let qt=class extends lt{static{this.styles=[wt,n`
      :host {
        display: block;
      }
      .card {
          ...
          <tbody>
            ${t.map(t=>{const e=t.priority>=3?"alarm-row-critical":t.priority>=2?"alarm-row-high":"",i=Zt.includes(t.runtime.state);return q`
                <tr class="${e} ${t.priority>=3&&i?"flashing":""}" @click=${()=>this._detailAlarm=t}>
                  ...
                  <td><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:${Ct(t.runtime.state)}" title="${Tt[t.runtime.state]??t.runtime.state}"></span></td>
        ...
        <tbody>
          ${e.map(t=>q`
              <tr>
                ...
                <td>${t.old_state?q`<span class="badge" style="background: ${Ct(t.old_state)}">${Tt[t.old_state]??t.old_state}</span>`:"-"}</td>
                <td>${t.new_state?q`<span class="badge" style="background: ${Ct(t.new_state)}">${Tt[t.new_state]??t.new_state}</span>`:"-"}</td>
                <td>${t.user??"-"}</td>
              </tr>
            `)}
        </tbody>
    ...
    `]}connectedCallback(){super.connectedCallback(),this._onDoc=this._onDoc.bind(this),document.addEventListener("mousedown",this._onDoc)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._onDoc)}_onDoc(t){t.composedPath().includes(this)||(this._open=!1)}_meta(t){return this.targets.find(e=>e.id===t)??{id:t,label:t,path:"M10 21H14C14 22.1 13.1 23 12 23S10 22.1 10 21M21 19V20H3V19L5 17V11C5 7.9 7 5.2 10 4.3V4C10 2.9 10.9 2 12 2S14 2.9 14 4V4.3C17 5.2 19 7.9 19 11V17L21 19M17 11C17 8.2 14.8 6 12 6S7 8.2 7 11V18H17V11Z"}}_emit(t){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t}}))}_add(t){this._emit([...this.value,t])}_remove(t){this._emit(this.value.filter(e=>e!==t))}render(){const t=this.targets.filter(t=>!this.value.includes(t.id));return q`
      ...
      ${this._open&&t.length>0?q`
          ...
          `:B}
    `}};t([ut({attribute:!1})],Xt.prototype,"value",void 0),t([ut({attribute:!1})],Xt.prototype,"targets",void 0),t([gt()],Xt.prototype,"_open",void 0),Xt=t([ct("notify-target-picker")],Xt);let Jt=class extends lt{constructor(){super(...arguments),this._channels=[],this._loading=!0,this._editing=null,this._formName="",this._formTargets=[],this._formMinPriority=0,this._formPersistent=!0,this._formMobile=!0,this._formCritical=!1,this._filterName=""}static{this.styles=[wt,n`
      :host { display: block; padding: 16px; }
      .form-card {
        background: var(--card-background-color, white);
        border: 1px solid var(--divider-color, #e0e0e0);
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadStats()}async _loadStats(){if(this.hass)try{const[t,e]=await Promise.all([At(this.hass),Mt(this.hass)]);this._alarmCount=t.length,this._channelCount=e.length}finally{this._loading=!1}}render(){return this._loading?q`<div class="empty-state">Loading...</div>`:q`
