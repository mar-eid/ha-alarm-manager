...
`,$t=t=>({0:"#2196F3",1:"#FF9800",2:"#FF5722",3:"#F44336"}[t]??"#9E9E9E"),wt=t=>({normal:"#4CAF50",active_unacknowledged:"#F44336",active_acknowledged:"#FF9800",returned_to_normal_unacknowledged:"#FF9800",shelved:"#9C27B0",disabled:"#9E9E9E"}[t]??"#9E9E9E"),kt=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/list"})).alarms,Ct=async(t,e,i)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/shelve",alarm_id:e,duration:i})},At=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/channel/list"})).channels,Et=async(t,e)=>t.connection.subscribeMessage(e,{type:"scada_alarm_manager/subscribe"}),St={0:"Info",1:"Warning",2:"High",3:"Critical"},Lt={normal:"Normal",active_unacknowledged:"Active (Unacked)",active_acknowledged:"Active (Acked)",returned_to_normal_unacknowledged:"RTN (Unacked)",shelved:"Shelved",disabled:"Disabled"},Mt=["active_unacknowledged","active_acknowledged","returned_to_normal_unacknowledged"],Tt=["active_unacknowledged","returned_to_normal_unacknowledged"],Pt=[3,2,1,0],Ht={0:"M13,9H11V7H13M13,17H11V11H13M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z",1:vt,2:"M13 13H11V7H13M11 15H13V17H11M15.73 3H8.27L3 8.27V15.73L8.27 21H15.73L21 15.73V8.27L15.73 3Z",3:mt};let Vt=class extends lt{constructor(){super(...arguments),this.alarms=[],this.filterPriority=""}static{this.styles=[xt,n`
  ...
  `}render(){const t=$t(this.priority),e=St[this.priority]??"Unknown";return j`
    ...
    `}};t([ut({attribute:!1})],zt.prototype,"alarm",void 0),t([ut({type:Boolean})],zt.prototype,"open",void 0),zt=t([ct("alarm-detail-dialog")],zt);const Ut=o("#9c27b0"),It=[15,30,60,240,480];let Ot=class extends lt{constructor(){super(...arguments),this.open=!1,this.alarmId="",this.alarmName="",this._minutes=15}static{this.styles=[xt,n`
      .overlay {
        position: fixed;
        inset: 0;
        z-index: 1000;
      ...
      .chip.sel {
        border-color: ${Ut};
        background: color-mix(in srgb, ${Ut} 14%, transparent);
        color: ${Ut};
      }
      .slider {
        display: flex;
    ...
    `:j``}};t([ut({type:Boolean})],Ot.prototype,"open",void 0),t([ut()],Ot.prototype,"alarmId",void 0),t([ut()],Ot.prototype,"alarmName",void 0),t([gt()],Ot.prototype,"_minutes",void 0),Ot=t([ct("shelve-dialog")],Ot);const Dt=["active_unacknowledged","returned_to_normal_unacknowledged"];let Rt=class extends lt{static{this.styles=[xt,n`
      :host {
        display: block;
      }
      .card {
    ...
    `}};t([ut({attribute:!1})],Rt.prototype,"alarm",void 0),Rt=t([ct("alarm-tile-card")],Rt);let Ft=class extends lt{constructor(){super(...arguments),this.priorityFilter="",this._alarms=[],this._loading=!0,this._layout="table",this._filterPriority="",this._filterName="",this._filterState="",this._filterSource=""}static{this.styles=[xt,n`
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadAlarms(),this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.()}async _loadAlarms(){if(this.hass)try{const t=await kt(this.hass);this._alarms=t.filter(t=>"active_unacknowledged"===t.runtime.state||"active_acknowledged"===t.runtime.state||"returned_to_normal_unacknowledged"===t.runtime.state)}finally{this._loading=!1}}async _subscribe(){this.hass&&(this._unsub=await Et(this.hass,()=>{this._loadAlarms()}))}get _filtered(){return this._alarms.filter(t=>{const e=this.priorityFilter||this._filterPriority;return(!e||String(t.priority)===e)&&(!(this._filterName&&!t.name.toLowerCase().includes(this._filterName.toLowerCase()))&&((!this._filterState||t.runtime.state===this._filterState)&&!(this._filterSource&&!t.source_entity_id.toLowerCase().includes(this._filterSource.toLowerCase()))))}).sort((t,e)=>e.priority-t.priority)}async _ack(t){this.hass&&(await(async(t,e)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/acknowledge",alarm_id:e})})(this.hass,t),this._loadAlarms())}_shelve(t){this._shelveTarget=t}render(){if(this._loading)return j`<div class="empty-state">Loading...</div>`;if(0===this._alarms.length)return j`
      ...
      ></shelve-dialog>
    `}};t([ut({attribute:!1})],Ft.prototype,"hass",void 0),t([ut()],Ft.prototype,"priorityFilter",void 0),t([gt()],Ft.prototype,"_alarms",void 0),t([gt()],Ft.prototype,"_loading",void 0),t([gt()],Ft.prototype,"_detailAlarm",void 0),t([gt()],Ft.prototype,"_shelveTarget",void 0),t([gt()],Ft.prototype,"_layout",void 0),t([gt()],Ft.prototype,"_filterPriority",void 0),t([gt()],Ft.prototype,"_filterName",void 0),t([gt()],Ft.prototype,"_filterState",void 0),t([gt()],Ft.prototype,"_filterSource",void 0),Ft=t([ct("active-alarms-view")],Ft);let qt=class extends lt{constructor(){super(...arguments),this.priorityFilter="",this._alarms=[],this._channels=[],this._loading=!0,this._filterPriority="",this._filterName="",this._filterState="",this._filterEntity="",this._filterTrigger="",this._filterChannel="",this._filterEnabled=""}static{this.styles=[xt,n`
      :host { display: block; padding: 16px; }
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadStats()}async _loadStats(){if(this.hass)try{const[t,e]=await Promise.all([kt(this.hass),At(this.hass)]);this._alarmCount=t.length,this._channelCount=e.length}finally{this._loading=!1}}render(){return this._loading?j`<div class="empty-state">Loading...</div>`:j`
    ...
    `}render(){const t="active"===this._activeTab||"all"===this._activeTab;return j`
      <div class="header">
    ...
    `}_renderView(){switch(this._activeTab){case"active":return j`<active-alarms-view
        ...
        ></create-edit-view>`;case"settings":return j`<settings-view .hass=${this.hass}></settings-view>`;default:return j`<active-alarms-view .hass=${this.hass}></active-alarms-view>`}}};t([ut({attribute:!1})],Qt.prototype,"hass",void 0),t([ut({attribute:!1})],Qt.prototype,"panel",void 0),t([gt()],Qt.prototype,"_activeTab",void 0),t([gt()],Qt.prototype,"_editAlarmId",void 0),t([gt()],Qt.prototype,"_priorityFilter",void 0),t([gt()],Qt.prototype,"_alarms",void 0),Qt=t([ct("scada-alarm-overview")],Qt);export{Qt as ScadaAlarmOverview};
