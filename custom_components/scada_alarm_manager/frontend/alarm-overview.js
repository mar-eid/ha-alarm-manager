...
`,mt=t=>({0:"#2196F3",1:"#FF9800",2:"#FF5722",3:"#F44336"}[t]??"#9E9E9E"),_t=t=>({normal:"#4CAF50",active_unacknowledged:"#F44336",active_acknowledged:"#FF9800",returned_to_normal_unacknowledged:"#FF9800",shelved:"#9C27B0",disabled:"#9E9E9E"}[t]??"#9E9E9E");let ft=class extends lt{static{this.styles=[vt,n`
    ...
    `}render(){const t=this.alarms.filter(t=>Nt.includes(t.runtime.state)),e=e=>t.filter(t=>t.priority===e).length,i=t.filter(t=>Dt.includes(t.runtime.state)).length,a=this.alarms.filter(t=>"shelved"===t.runtime.state).length,s=t.length,o=It.map(t=>({p:t,n:e(t)})).filter(t=>t.n>0);return R`
      <div class="kpis">
        ...
        ${It.map(t=>this._tile(mt(t),e(t),Vt[t],Ot[t],String(t)))}
      ...
      ${s>0?R`
          ...
          `:B}
    `}};t([gt({attribute:!1})],Ut.prototype,"alarms",void 0),t([gt()],Ut.prototype,"filterPriority",void 0),Ut=t([ct("alarm-kpi-strip")],Ut);let qt=class extends lt{constructor(){super(...arguments),this.open=!1,this.version=""}static{this.styles=[vt,n`
      .overlay {
    ...
    `:R``}};t([gt({type:Boolean})],qt.prototype,"open",void 0),t([gt({type:String})],qt.prototype,"version",void 0),qt=t([ct("help-dialog")],qt);const jt={0:Tt,1:bt,2:xt,3:yt};let Ft=class extends lt{constructor(){super(...arguments),this.priority=0}static{this.styles=n`
    .badge {
      display: inline-flex;
      align-items: center;
      justify-content: center;
  ...
  `}render(){const t=mt(this.priority),e=Vt[this.priority]??"Unknown";return R`
      <span
        class="badge"
    ...
    `}};t([gt({type:Number})],Ft.prototype,"priority",void 0),Ft=t([ct("severity-badge")],Ft);let Rt=class extends lt{constructor(){super(...arguments),this.open=!1}static{this.styles=[vt,n`
      .overlay {
        position: fixed; top: 0; left: 0; right: 0; bottom: 0;
        background: rgba(0, 0, 0, 0.5);
        display: flex; align-items: center; justify-content: center;
          ...
          <div class="dialog-body">
            ...
            <div class="section">
              ...
              <div class="field">
                ...
                <span class="field-value"><span class="badge" style="background: ${_t(e.state)}">${zt[e.state]??e.state}</span></span>
              </div>
              <div class="field">
            ...
            <div class="section">
              ...
              <div class="field">
                ...
                <span class="field-value">${Vt[t.priority]}</span>
              </div>
              <div class="field">
    ...
    `}};t([gt({attribute:!1})],Rt.prototype,"alarm",void 0),t([gt({type:Boolean})],Rt.prototype,"open",void 0),Rt=t([ct("alarm-detail-dialog")],Rt);const Zt=r("#9c27b0"),Bt=[15,30,60,240,480];let Wt=class extends lt{constructor(){super(...arguments),this.open=!1,this.alarmId="",this.alarmName="",this._minutes=15}static{this.styles=[vt,n`
      .overlay {
        position: fixed;
        inset: 0;
        z-index: 1000;
      ...
      .chip.sel {
        border-color: ${Zt};
        background: color-mix(in srgb, ${Zt} 14%, transparent);
        color: ${Zt};
      }
      .slider {
        display: flex;
    ...
    `:R``}};t([gt({type:Boolean})],Wt.prototype,"open",void 0),t([gt()],Wt.prototype,"alarmId",void 0),t([gt()],Wt.prototype,"alarmName",void 0),t([ut()],Wt.prototype,"_minutes",void 0),Wt=t([ct("shelve-dialog")],Wt);const Kt=["active_unacknowledged","returned_to_normal_unacknowledged"];let Yt=class extends lt{static{this.styles=[vt,n`
      :host {
        display: block;
      }
      .card {
      ...
      <div class="card" @click=${()=>this._emit("open-alarm",{alarm:t})}>
        ...
        <div class="mid">
          ...
          >
            ...
            ${zt[t.runtime.state]??t.runtime.state}
          </span>
        </div>
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadAlarms(),this._loadChannels(),this._subscribe()}async _loadChannels(){this.hass&&(this._channels=await Lt(this.hass))}get _tags(){return[...new Set(this._alarms.map(t=>t.tag).filter(Boolean))].sort()}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.()}async _loadAlarms(){if(this.hass)try{const t=await Et(this.hass);this._alarms=t.filter(t=>"active_unacknowledged"===t.runtime.state||"active_acknowledged"===t.runtime.state||"returned_to_normal_unacknowledged"===t.runtime.state)}finally{this._loading=!1}}async _subscribe(){this.hass&&(this._unsub=await Ht(this.hass,()=>this._loadAlarms()))}get _filtered(){return this._alarms.filter(t=>{const e=this.priorityFilter||this._filterPriority;if(e&&String(t.priority)!==e)return!1;if(this._filterState&&t.runtime.state!==this._filterState)return!1;if(this._filterTag&&t.tag!==this._filterTag)return!1;if(this._filterChannel&&t.channel_id!==this._filterChannel)return!1;if(this._search){const e=this._search.toLowerCase();if(!t.name.toLowerCase().includes(e)&&!t.area.toLowerCase().includes(e)&&!t.source_entity_id.toLowerCase().includes(e))return!1}return!0}).sort((t,e)=>e.priority-t.priority)}_showToast(t){this._toast=t,setTimeout(()=>this._toast="",2600)}async _ack(t){this.hass&&(await St(this.hass,t),this._showToast("Alarm acknowledged"),this._loadAlarms())}async _ackAll(){if(!this.hass)return;const t=await(async t=>t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/acknowledge_all"}))(this.hass);this._showToast(`Acknowledged ${t.acknowledged} alarms`),this._loadAlarms()}_shelve(t){this._shelveTarget=t}_edit(t){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:"create-edit",alarmId:t},bubbles:!0,composed:!0}))}render(){if(this._loading)return R`<div class="empty-state">Loading...</div>`;if(0===this._alarms.length)return R`
      ...
      <alarm-detail-dialog
        ...
        @edit-alarm=${t=>this._edit(t.detail.id)}
        @ack-alarm=${t=>this._ack(t.detail.id)}
        @shelve-alarm=${t=>this._shelve(t.detail.alarm)}
      ></alarm-detail-dialog>
    ...
    `]}connectedCallback(){super.connectedCallback(),this._onDoc=this._onDoc.bind(this),document.addEventListener("mousedown",this._onDoc)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._onDoc)}_onDoc(t){t.composedPath().includes(this)||(this._open=!1)}_meta(t){return this.targets.find(e=>e.id===t)??{id:t,label:t,path:$t}}_emit(t){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t}}))}_add(t){this._emit([...this.value,{target:t,min_priority:0}])}_remove(t){this._emit(this.value.filter(e=>e.target!==t))}_setPriority(t,e){this._emit(this.value.map(i=>i.target===t?{...i,min_priority:e}:i))}render(){const t=this.value.map(t=>t.target),e=this.targets.filter(e=>!t.includes(e.id)),i={0:"All",1:"Warn+",2:"High+",3:"Crit"};return R`
      ...
      ${this._open&&e.length>0?R`
          ...
          `:B}
    `}};t([gt({attribute:!1})],ee.prototype,"value",void 0),t([gt({attribute:!1})],ee.prototype,"targets",void 0),t([ut()],ee.prototype,"_open",void 0),ee=t([ct("notify-target-picker")],ee);let ie=class extends lt{constructor(){super(...arguments),this._channels=[],this._loading=!0,this._editing=null,this._formName="",this._formTargets=[],this._formMinPriority=0,this._formPersistent=!0,this._formMobile=!0,this._formCritical=!1,this._filterName=""}get _notifyTargets(){return this.hass?.services?.notify?Object.keys(this.hass.services.notify).filter(t=>"send_message"!==t&&"persistent_notification"!==t).map(t=>({id:`notify.${t}`,label:t.replace(/_/g," ").replace(/\b\w/g,t=>t.toUpperCase()),path:$t})):[]}static{this.styles=[vt,n`
      :host { display: block; padding: 16px; }
      .form-card {
        background: var(--card-background-color, white);
        border: 1px solid var(--divider-color, #e0e0e0);
        ...
        <div class="section">
          ...
          ${a.map(t=>R`
            <div class="freq-row">
              ...
              <span style="font-size:0.8em;color:var(--secondary-text-color)">${Vt[t.priority]}</span>
            </div>
          `)}
        </div>
      `:""}
