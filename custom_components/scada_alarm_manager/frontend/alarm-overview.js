 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return gt({...t,state:!0,attribute:!1})}const mt=n`
  :host {
...
`,vt=t=>({0:"#2196F3",1:"#FF9800",2:"#FF5722",3:"#F44336"}[t]??"#9E9E9E"),_t=t=>({normal:"#4CAF50",active_unacknowledged:"#F44336",active_acknowledged:"#FF9800",returned_to_normal_unacknowledged:"#FF9800",shelved:"#9C27B0",disabled:"#9E9E9E"}[t]??"#9E9E9E");let ft=class extends lt{static{this.styles=[mt,n`
    ...
    `}render(){const t=this.alarms.filter(t=>Nt.includes(t.runtime.state)),e=e=>t.filter(t=>t.priority===e).length,i=t.filter(t=>Dt.includes(t.runtime.state)).length,a=this.alarms.filter(t=>"shelved"===t.runtime.state).length,s=t.length,o=It.map(t=>({p:t,n:e(t)})).filter(t=>t.n>0);return R`
      ...
      ${s>0?R`
          ...
          `:B}
    `}};t([gt({attribute:!1})],Ut.prototype,"alarms",void 0),t([gt()],Ut.prototype,"filterPriority",void 0),Ut=t([ct("alarm-kpi-strip")],Ut);let qt=class extends lt{constructor(){super(...arguments),this.open=!1}static{this.styles=[mt,n`
      .overlay {
