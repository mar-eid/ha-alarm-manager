 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ct=t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)},pt={attribute:!0,type:String,converter:y,reflect:!1,hasChanged:x},ht=(t=pt,e,i)=>{const{kind:a,metadata:s}=i;let o=globalThis.litPropertyMetadata.get(s);if(void 0===o&&globalThis.litPropertyMetadata.set(s,o=new Map),"setter"===a&&((t=Object.create(t)).wrapped=!0),o.set(i.name,t),"accessor"===a){const{name:a}=i;return{set(i){const s=e.get.call(this);e.set.call(this,i),this.requestUpdate(a,s,t,!0,i)},init(e){return void 0!==e&&this.C(a,void 0,t,e),e}}}if("setter"===a){const{name:a}=i;return function(i){const s=this[a];e.call(this,i),this.requestUpdate(a,s,t,!0,i)}}throw Error("Unsupported decorator location: "+a)};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ut(t){return(e,i)=>"object"==typeof i?ht(t,e,i):((t,e,i)=>{const a=e.hasOwnProperty(i);return e.constructor.createProperty(i,t),a?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function gt(t){return ut({...t,state:!0,attribute:!1})}const mt=n`
  :host {
...
`,vt=t=>({0:"#2196F3",1:"#FF9800",2:"#FF5722",3:"#F44336"}[t]??"#9E9E9E"),_t=t=>({normal:"#4CAF50",active_unacknowledged:"#F44336",active_acknowledged:"#FF9800",returned_to_normal_unacknowledged:"#FF9800",shelved:"#9C27B0",disabled:"#9E9E9E"}[t]??"#9E9E9E");let ft=class extends lt{static{this.styles=[mt,n`
      :host { display: block; }
      ...
      <div class="row">
        <div class="form-group">
          ...
          <select .value=${this._config.default_tab??"active"}
            @change=${t=>this._update("default_tab",t.target.value)}>
        ...
        <div class="form-group">
          ...
          <input type="text"
            ...
            @input=${t=>this._update("max_width",t.target.value)}
    ...
    `}render(){const t=this.alarms.filter(t=>zt.includes(t.runtime.state)),e=e=>t.filter(t=>t.priority===e).length,i=t.filter(t=>Nt.includes(t.runtime.state)).length,a=this.alarms.filter(t=>"shelved"===t.runtime.state).length,s=t.length,o=It.map(t=>({p:t,n:e(t)})).filter(t=>t.n>0);return F`
      <div class="kpis">
        ${this._tile("#5e5e5e",s,"Active alarms",wt,null)}
        ${It.map(t=>this._tile(vt(t),e(t),Pt[t],Dt[t],String(t)))}
      ...
      ${s>0?F`
          ...
          `:B}
    `}};t([ut({attribute:!1})],Ot.prototype,"alarms",void 0),t([ut()],Ot.prototype,"filterPriority",void 0),Ot=t([ct("alarm-kpi-strip")],Ot);let Ut=class extends lt{constructor(){super(...arguments),this.open=!1}static{this.styles=[mt,n`
      .overlay {
    ...
    `:F``}};t([ut({type:Boolean})],Ut.prototype,"open",void 0),Ut=t([ct("help-dialog")],Ut);const qt={0:Mt,1:bt,2:xt,3:yt};let jt=class extends lt{constructor(){super(...arguments),this.priority=0}static{this.styles=n`
    .badge {
      display: inline-flex;
      align-items: center;
      justify-content: center;
  ...
  `}render(){const t=vt(this.priority),e=Pt[this.priority]??"Unknown";return F`
      <span
        class="badge"
        style="background: color-mix(in srgb, ${t} 18%, transparent); color: ${t}"
        title=${e}
      >
        <ha-svg-icon .path=${qt[this.priority]}></ha-svg-icon>
      </span>
    `}};t([ut({type:Number})],jt.prototype,"priority",void 0),jt=t([ct("severity-badge")],jt);let Rt=class extends lt{constructor(){super(...arguments),this.open=!1}static{this.styles=[mt,n`
      .overlay {
        position: fixed; top: 0; left: 0; right: 0; bottom: 0;
        background: rgba(0, 0, 0, 0.5);
        display: flex; align-items: center; justify-content: center;
    ...
    `]}_close(){this.open=!1,this.dispatchEvent(new CustomEvent("close"))}_emit(t,e={}){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_openEntityInfo(){this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:this.alarm?.source_entity_id},bubbles:!0,composed:!0}))}render(){if(!this.open||!this.alarm)return F``;const t=this.alarm,e=t.runtime;return F`
      <div class="overlay" @click=${this._close}>
        <div class="dialog" @click=${t=>t.stopPropagation()}>
          <div class="dialog-header">
            <h2>
              <span class="priority-dot" style="background: ${vt(t.priority)}"></span>
              ${t.name}
            </h2>
            <button class="close-btn" @click=${this._close}>&times;</button>
          </div>
          <div class="dialog-body">
            ...
            <div class="section">
              ...
              <div class="field">
                ...
                <span class="field-value"><span class="badge" style="background: ${_t(e.state)}">${Vt[e.state]??e.state}</span></span>
              </div>
              <div class="field">
            ...
            <div class="section">
              ...
              <div class="field">
                ...
                <span class="field-value">${Pt[t.priority]}</span>
              </div>
              <div class="field">
                <span class="field-label">Source Entity</span>
                <span class="entity-link" @click=${this._openEntityInfo}>${t.source_entity_id}</span>
              </div>
              <div class="field">
    ...
    `}};t([ut({attribute:!1})],Rt.prototype,"alarm",void 0),t([ut({type:Boolean})],Rt.prototype,"open",void 0),Rt=t([ct("alarm-detail-dialog")],Rt);const Ft=r("#9c27b0"),Zt=[15,30,60,240,480];let Bt=class extends lt{constructor(){super(...arguments),this.open=!1,this.alarmId="",this.alarmName="",this._minutes=15}static{this.styles=[mt,n`
      .overlay {
        position: fixed;
        inset: 0;
        z-index: 1000;
      ...
      .chip.sel {
        border-color: ${Ft};
        background: color-mix(in srgb, ${Ft} 14%, transparent);
        color: ${Ft};
      }
      .slider {
        display: flex;
    ...
    `:F``}};t([ut({type:Boolean})],Bt.prototype,"open",void 0),t([ut()],Bt.prototype,"alarmId",void 0),t([ut()],Bt.prototype,"alarmName",void 0),t([gt()],Bt.prototype,"_minutes",void 0),Bt=t([ct("shelve-dialog")],Bt);const Wt=["active_unacknowledged","returned_to_normal_unacknowledged"];let Kt=class extends lt{static{this.styles=[mt,n`
      :host {
        display: block;
      }
      .card {
    ...
    `]}_emit(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}willUpdate(){const t=this.alarm,e=t&&t.priority>=3&&Wt.includes(t.runtime.state);this.toggleAttribute("flashing",!!e)}render(){const t=this.alarm;if(!t)return F``;const e=vt(t.priority),i=_t(t.runtime.state),a=Wt.includes(t.runtime.state);return F`
      <div class="card" @click=${()=>this._emit("open-alarm",{alarm:t})}>
        ...
        <div class="mid">
          ...
          >
            ...
            ${Vt[t.runtime.state]??t.runtime.state}
          </span>
        </div>
    ...
    `}};t([ut({attribute:!1})],Kt.prototype,"alarm",void 0),Kt=t([ct("alarm-tile-card")],Kt);const Yt=["active_unacknowledged","returned_to_normal_unacknowledged"];let Jt=class extends lt{constructor(){super(...arguments),this.priorityFilter="",this._alarms=[],this._loading=!0,this._layout="table",this._search="",this._toast="",this._filterPriority="",this._filterState=""}static{this.styles=[mt,n`
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadAlarms(),this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.()}async _loadAlarms(){if(this.hass)try{const t=await Tt(this.hass);this._alarms=t.filter(t=>"active_unacknowledged"===t.runtime.state||"active_acknowledged"===t.runtime.state||"returned_to_normal_unacknowledged"===t.runtime.state)}finally{this._loading=!1}}async _subscribe(){this.hass&&(this._unsub=await Ht(this.hass,()=>this._loadAlarms()))}get _filtered(){return this._alarms.filter(t=>{const e=this.priorityFilter||this._filterPriority;if(e&&String(t.priority)!==e)return!1;if(this._filterState&&t.runtime.state!==this._filterState)return!1;if(this._search){const e=this._search.toLowerCase();if(!t.name.toLowerCase().includes(e)&&!t.area.toLowerCase().includes(e)&&!t.source_entity_id.toLowerCase().includes(e))return!1}return!0}).sort((t,e)=>e.priority-t.priority)}_showToast(t){this._toast=t,setTimeout(()=>this._toast="",2600)}async _ack(t){this.hass&&(await(async(t,e)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/acknowledge",alarm_id:e})})(this.hass,t),this._showToast("Alarm acknowledged"),this._loadAlarms())}async _ackAll(){if(!this.hass)return;const t=await(async t=>t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/acknowledge_all"}))(this.hass);this._showToast(`Acknowledged ${t.acknowledged} alarms`),this._loadAlarms()}_shelve(t){this._shelveTarget=t}render(){if(this._loading)return F`<div class="empty-state">Loading...</div>`;if(0===this._alarms.length)return F`
      ...
      `:F`
        <table>
            ...
            <tr class="filter-row">
              <th>
                <select @change=${t=>this._filterPriority=t.target.value}>
                  ...
                  ${[0,1,2,3].map(t=>F`<option value=${t}>${Pt[t]}</option>`)}
                </select>
              </th>
              <th></th>
              <th>
                <select @change=${t=>this._filterState=t.target.value}>
                  <option value="">All</option>
                  ${["active_unacknowledged","active_acknowledged","returned_to_normal_unacknowledged"].map(t=>F`<option value=${t}>${Vt[t]}</option>`)}
                </select>
              </th>
              <th></th>
              <th></th>
          ...
          <tbody>
            ${t.map(t=>{const e=t.priority>=3?"alarm-row-critical":t.priority>=2?"alarm-row-high":"",i=Yt.includes(t.runtime.state);return F`
                <tr class="${e} ${t.priority>=3&&i?"flashing":""}" @click=${()=>this._detailAlarm=t}>
                  ...
                  <td><span style="display:inline-block;width:10px;height:10px;border-radius:50%;background:${_t(t.runtime.state)}" title="${Vt[t.runtime.state]??t.runtime.state}"></span></td>
      ...
      <shelve-dialog
        ...
        @shelve-confirm=${async t=>{await Et(this.hass,t.detail.alarmId,t.detail.minutes),this._shelveTarget=void 0,this._showToast("Alarm shelved"),this._loadAlarms()}}
      ></shelve-dialog>

      ${this._toast?F`<div class="toast">${this._toast}</div>`:B}
    `}};t([ut({attribute:!1})],Jt.prototype,"hass",void 0),t([ut()],Jt.prototype,"priorityFilter",void 0),t([gt()],Jt.prototype,"_alarms",void 0),t([gt()],Jt.prototype,"_loading",void 0),t([gt()],Jt.prototype,"_detailAlarm",void 0),t([gt()],Jt.prototype,"_shelveTarget",void 0),t([gt()],Jt.prototype,"_layout",void 0),t([gt()],Jt.prototype,"_search",void 0),t([gt()],Jt.prototype,"_toast",void 0),t([gt()],Jt.prototype,"_filterPriority",void 0),t([gt()],Jt.prototype,"_filterState",void 0),Jt=t([ct("active-alarms-view")],Jt);let Gt=class extends lt{constructor(){super(...arguments),this.priorityFilter="",this._alarms=[],this._channels=[],this._loading=!0,this._filterPriority="",this._filterName="",this._filterState="",this._filterEntity="",this._filterTrigger="",this._filterChannel="",this._filterEnabled="",this._toast=""}static{this.styles=[mt,n`
      :host { display: block; padding: 16px; }
    ...
    `]}connectedCallback(){super.connectedCallback(),this._load()}async _load(){if(this.hass)try{const[t,e]=await Promise.all([Tt(this.hass),St(this.hass)]);this._alarms=t,this._channels=e}finally{this._loading=!1}}_getChannelName(t){if(!t)return"-";const e=this._channels.find(e=>e.id===t);return e?e.name:t}get _filtered(){return this._alarms.filter(t=>{const e=this.priorityFilter||this._filterPriority;if(e&&String(t.priority)!==e)return!1;if(this._filterName&&!t.name.toLowerCase().includes(this._filterName.toLowerCase()))return!1;if(this._filterState&&t.runtime.state!==this._filterState)return!1;if(this._filterEntity&&!t.source_entity_id.toLowerCase().includes(this._filterEntity.toLowerCase()))return!1;if(this._filterTrigger&&t.trigger_type!==this._filterTrigger)return!1;if(this._filterChannel){if(!this._getChannelName(t.channel_id).toLowerCase().includes(this._filterChannel.toLowerCase()))return!1}return!("yes"===this._filterEnabled&&!t.enabled)&&("no"!==this._filterEnabled||!t.enabled)})}_showToast(t){this._toast=t,setTimeout(()=>this._toast="",2600)}_confirmDelete(t){this._deleteTarget=t}async _doDelete(){if(!this.hass||!this._deleteTarget)return;const t=this._deleteTarget.name;await(async(t,e)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/delete",alarm_id:e})})(this.hass,this._deleteTarget.id),this._deleteTarget=void 0,this._showToast(`Deleted: ${t}`),this._load()}_edit(t){this.dispatchEvent(new CustomEvent("navigate",{detail:{view:"create-edit",alarmId:t},bubbles:!0,composed:!0}))}async _testNotification(t){this.hass&&t.channel_id&&await this.hass.callService("scada_alarm_manager","test_notification",{channel_id:t.channel_id})}_shelve(t){this._shelveTarget=t}async _unshelve(t){this.hass&&(await(async(t,e)=>{await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/unshelve",alarm_id:e})})(this.hass,t),this._load())}render(){if(this._loading)return F`<div class="empty-state">Loading...</div>`;const t=this._filtered;return F`
        ...
        <thead>
          ...
          <tr class="filter-row">
            ...
            <th>
              <select @change=${t=>this._filterState=t.target.value}>
                <option value="">All</option>
                ${Object.entries(Vt).map(([t,e])=>F`<option value=${t}>${e}</option>`)}
              </select>
            </th>
      ...
      <shelve-dialog
        ...
        .alarmName=${this._shelveTarget?.name??""}
        @dialog-closed=${()=>this._shelveTarget=void 0}
        @shelve-confirm=${async t=>{await Et(this.hass,t.detail.alarmId,t.detail.minutes),this._shelveTarget=void 0,this._showToast("Alarm shelved"),this._load()}}
      ></shelve-dialog>
    ...
    `}};t([ut({attribute:!1})],Gt.prototype,"hass",void 0),t([ut()],Gt.prototype,"priorityFilter",void 0),t([gt()],Gt.prototype,"_alarms",void 0),t([gt()],Gt.prototype,"_channels",void 0),t([gt()],Gt.prototype,"_loading",void 0),t([gt()],Gt.prototype,"_detailAlarm",void 0),t([gt()],Gt.prototype,"_shelveTarget",void 0),t([gt()],Gt.prototype,"_filterPriority",void 0),t([gt()],Gt.prototype,"_filterName",void 0),t([gt()],Gt.prototype,"_filterState",void 0),t([gt()],Gt.prototype,"_filterEntity",void 0),t([gt()],Gt.prototype,"_filterTrigger",void 0),t([gt()],Gt.prototype,"_filterChannel",void 0),t([gt()],Gt.prototype,"_filterEnabled",void 0),t([gt()],Gt.prototype,"_deleteTarget",void 0),t([gt()],Gt.prototype,"_toast",void 0),Gt=t([ct("all-alarms-view")],Gt);let Xt=class extends lt{constructor(){super(...arguments),this._events=[],this._loading=!0,this._offset=0,this._limit=50,this._filterAlarm="",this._filterEvent="",this._filterUser=""}static{this.styles=[mt,n`
      :host { display: block; padding: 16px; }
        ...
        <tbody>
          ${e.map(t=>F`
              <tr>
                ...
                <td>${t.old_state?F`<span class="badge" style="background: ${_t(t.old_state)}">${Vt[t.old_state]??t.old_state}</span>`:"-"}</td>
                <td>${t.new_state?F`<span class="badge" style="background: ${_t(t.new_state)}">${Vt[t.new_state]??t.new_state}</span>`:"-"}</td>
                <td>${t.user??"-"}</td>
              </tr>
            `)}
        </tbody>
    ...
    `]}connectedCallback(){super.connectedCallback(),this._onDoc=this._onDoc.bind(this),document.addEventListener("mousedown",this._onDoc)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("mousedown",this._onDoc)}_onDoc(t){t.composedPath().includes(this)||(this._open=!1)}_meta(t){return this.targets.find(e=>e.id===t)??{id:t,label:t,path:$t}}_emit(t){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t}}))}_add(t){this._emit([...this.value,{target:t,min_priority:0}])}_remove(t){this._emit(this.value.filter(e=>e.target!==t))}_setPriority(t,e){this._emit(this.value.map(i=>i.target===t?{...i,min_priority:e}:i))}render(){const t=this.value.map(t=>t.target),e=this.targets.filter(e=>!t.includes(e.id)),i={0:"All",1:"Warn+",2:"High+",3:"Crit"};return F`
      <div class="box">
        ...
        ${this.value.map(t=>{const e=this._meta(t.target);return F`
          ...
          `})}
        <button class="add" ?disabled=${0===e.length} @click=${()=>this._open=!this._open}>
      ...
      ${this._open&&e.length>0?F`
          ...
          `:B}
    `}};t([ut({attribute:!1})],te.prototype,"value",void 0),t([ut({attribute:!1})],te.prototype,"targets",void 0),t([gt()],te.prototype,"_open",void 0),te=t([ct("notify-target-picker")],te);let ee=class extends lt{constructor(){super(...arguments),this._channels=[],this._loading=!0,this._editing=null,this._formName="",this._formTargets=[],this._formMinPriority=0,this._formPersistent=!0,this._formMobile=!0,this._formCritical=!1,this._filterName=""}get _notifyTargets(){return this.hass?.services?.notify?Object.keys(this.hass.services.notify).filter(t=>"send_message"!==t&&"persistent_notification"!==t).map(t=>({id:`notify.${t}`,label:t.replace(/_/g," ").replace(/\b\w/g,t=>t.toUpperCase()),path:$t})):[]}static{this.styles=[mt,n`
      :host { display: block; padding: 16px; }
      .form-card {
        background: var(--card-background-color, white);
        border: 1px solid var(--divider-color, #e0e0e0);
    ...
    `}_renderForm(){return F`
      <div class="form-card">
        ...
        <div class="form-group">
          ...
          <select title="Only alarms at this priority or higher will use this channel" .value=${String(this._formMinPriority)} @change=${t=>this._formMinPriority=Number(t.target.value)}>
        ...
        <div class="checkbox-group">
          <label title="Show alarm in HA UI persistent notifications panel"><input type="checkbox" .checked=${this._formPersistent} @change=${t=>this._formPersistent=t.target.checked} /> Persistent Notifications</label>
          <label title="Send push notification to mobile devices via Companion App"><input type="checkbox" .checked=${this._formMobile} @change=${t=>this._formMobile=t.target.checked} /> Mobile Push</label>
          <label title="Critical alerts bypass Do Not Disturb on iOS/Android"><input type="checkbox" .checked=${this._formCritical} @change=${t=>this._formCritical=t.target.checked} /> Critical Alerts</label>
        </div>
        <div class="actions">
    ...
    `}};t([ut({attribute:!1})],ee.prototype,"hass",void 0),t([gt()],ee.prototype,"_channels",void 0),t([gt()],ee.prototype,"_loading",void 0),t([gt()],ee.prototype,"_editing",void 0),t([gt()],ee.prototype,"_formName",void 0),t([gt()],ee.prototype,"_formTargets",void 0),t([gt()],ee.prototype,"_formMinPriority",void 0),t([gt()],ee.prototype,"_formPersistent",void 0),t([gt()],ee.prototype,"_formMobile",void 0),t([gt()],ee.prototype,"_formCritical",void 0),t([gt()],ee.prototype,"_filterName",void 0),ee=t([ct("channels-view")],ee);let ie=class extends lt{constructor(){super(...arguments),this._channels=[],this._loading=!0,this._saving=!1,this._name="",this._description="",this._sourceEntityId="",this._triggerType="digital",this._priority=1,this._area="",this._equipment="",this._tag="",this._channelId=null,this._enabled=!0,this._latching=!1,this._ackRequired=!0,this._autoClear=!0,this._conditionTemplate="",this._conditionMode="none",this._conditionEntity="",this._notificationTitleTemplate="",this._notificationTextTemplate="",this._conditionState="",this._remindIntervalMin="",this._analogOperator=">",this._analogThreshold="0",this._hysteresis="",this._digitalTargetState="on",this._customMatchValues=""}static{this.styles=[mt,n`
      ...
      <div class="form-card">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <select title="Determines notification behavior and visual severity" .value=${String(this._priority)} @change=${t=>this._priority=Number(t.target.value)}>
        ...
        <div class="section">
          ...
          <div class="form-group">
            ...
            <select title="How the alarm evaluates the source entity" .value=${this._triggerType} @change=${t=>this._triggerType=t.target.value}>
          ...
          ${"analog"===this._triggerType?F`
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input type="number" step="any" title="Prevents chattering: alarm triggers at threshold but won't clear until value passes threshold +/- this value" .value=${this._hysteresis} @input=${t=>this._hysteresis=t.target.value} placeholder="e.g. 2" />
        ...
        <div class="section">
          <h3>Behavior</h3>
          <div class="checkbox-group">
            <label title="When disabled, the alarm won't evaluate or trigger"><input type="checkbox" .checked=${this._enabled} @change=${t=>this._enabled=t.target.checked} /> Enabled</label>
            <label title="Latching alarms stay active until manually reset, even if condition clears"><input type="checkbox" .checked=${this._latching} @change=${t=>this._latching=t.target.checked} /> Latching</label>
            <label title="Require user to acknowledge alarm before it can return to normal"><input type="checkbox" .checked=${this._ackRequired} @change=${t=>this._ackRequired=t.target.checked} /> Acknowledge Required</label>
            <label title="Automatically clear alarm when the trigger condition is no longer met"><input type="checkbox" .checked=${this._autoClear} @change=${t=>this._autoClear=t.target.checked} /> Auto Clear</label>
          </div>
          <div class="form-group">
            ...
            <input type="number" min="0" step="any"
              ...
              @input=${t=>this._remindIntervalMin=t.target.value}
              placeholder="e.g. 30" />
          ...
          <div class="form-group">
            ...
            <div style="display:flex;gap:4px;margin-bottom:8px">
              <button class="btn btn-small" style=${"none"===this._conditionMode?"background:var(--primary-color);color:#fff":"background:var(--secondary-background-color)"}
                title="No additional condition — alarm triggers whenever the threshold is met"
                @click=${()=>this._conditionMode="none"}>None</button>
              <button class="btn btn-small" style=${"simple"===this._conditionMode?"background:var(--primary-color);color:#fff":"background:var(--secondary-background-color)"}
              ...
              <button class="btn btn-small" style=${"template"===this._conditionMode?"background:var(--primary-color);color:#fff":"background:var(--secondary-background-color)"}
    ...
    `}};t([ut({attribute:!1})],ie.prototype,"hass",void 0),t([ut()],ie.prototype,"alarmId",void 0),t([gt()],ie.prototype,"_channels",void 0),t([gt()],ie.prototype,"_loading",void 0),t([gt()],ie.prototype,"_saving",void 0),t([gt()],ie.prototype,"_name",void 0),t([gt()],ie.prototype,"_description",void 0),t([gt()],ie.prototype,"_sourceEntityId",void 0),t([gt()],ie.prototype,"_triggerType",void 0),t([gt()],ie.prototype,"_priority",void 0),t([gt()],ie.prototype,"_area",void 0),t([gt()],ie.prototype,"_equipment",void 0),t([gt()],ie.prototype,"_tag",void 0),t([gt()],ie.prototype,"_channelId",void 0),t([gt()],ie.prototype,"_enabled",void 0),t([gt()],ie.prototype,"_latching",void 0),t([gt()],ie.prototype,"_ackRequired",void 0),t([gt()],ie.prototype,"_autoClear",void 0),t([gt()],ie.prototype,"_conditionTemplate",void 0),t([gt()],ie.prototype,"_conditionMode",void 0),t([gt()],ie.prototype,"_conditionEntity",void 0),t([gt()],ie.prototype,"_notificationTitleTemplate",void 0),t([gt()],ie.prototype,"_notificationTextTemplate",void 0),t([gt()],ie.prototype,"_conditionState",void 0),t([gt()],ie.prototype,"_remindIntervalMin",void 0),t([gt()],ie.prototype,"_analogOperator",void 0),t([gt()],ie.prototype,"_analogThreshold",void 0),t([gt()],ie.prototype,"_hysteresis",void 0),t([gt()],ie.prototype,"_digitalTargetState",void 0),t([gt()],ie.prototype,"_customMatchValues",void 0),ie=t([ct("create-edit-view")],ie);const ae=["active_unacknowledged","active_acknowledged","returned_to_normal_unacknowledged"];let se=class extends lt{constructor(){super(...arguments),this._alarms=[],this._channelCount=0,this._events=[],this._loading=!0}static{this.styles=[mt,n`
      :host { display: block; padding: 16px; max-width: 800px; }
      .stats-grid {
        ...
        <div class="section">
          ...
          ${a.map(t=>F`
            <div class="freq-row">
              ...
              <span style="font-size:0.8em;color:var(--secondary-text-color)">${Pt[t.priority]}</span>
            </div>
          `)}
        </div>
      `:""}
    ...
    `}render(){if(!this._config)return F``;const t=this._config.show_header??!1,e=this._config.max_width??"",i="active"===this._activeTab||"all"===this._activeTab;return F`
      ...
      <div class="tabs">
        ...
        <button class="help-btn" title="Quick start guide" @click=${()=>this._showHelp=!0}>
          <ha-svg-icon .path=${"M11,18H13V16H11V18M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,6A4,4 0 0,0 8,10H10A2,2 0 0,1 12,8A2,2 0 0,1 14,10C14,12 11,11.75 11,15H13C13,12.75 16,12.5 16,10A4,4 0 0,0 12,6Z"}></ha-svg-icon>
        </button>
      </div>
    ...
    `}_renderView(){switch(this._activeTab){case"active":return F`<active-alarms-view
        ...
        ></create-edit-view>`;case"settings":return F`<settings-view .hass=${this.hass}></settings-view>`;default:return F`<active-alarms-view .hass=${this.hass}></active-alarms-view>`}}};t([ut({attribute:!1})],ne.prototype,"hass",void 0),t([gt()],ne.prototype,"_config",void 0),t([gt()],ne.prototype,"_activeTab",void 0),t([gt()],ne.prototype,"_editAlarmId",void 0),t([gt()],ne.prototype,"_priorityFilter",void 0),t([gt()],ne.prototype,"_alarms",void 0),t([gt()],ne.prototype,"_showHelp",void 0),ne=t([ct("scada-alarm-overview")],ne),window.customCards=window.customCards||[],window.customCards.push({type:"scada-alarm-overview",name:"SCADA Alarm Overview",description:"Full Alarm Center with tabs, KPI strip, and management views. Best in panel mode."});export{ne as ScadaAlarmOverview};
