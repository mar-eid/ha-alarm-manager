 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function _t(t){return pt({...t,state:!0,attribute:!1})}const ut=o`
  :host {
...
`,gt=t=>({0:"#2196F3",1:"#FF9800",2:"#FF5722",3:"#F44336"}[t]??"#9E9E9E"),mt=t=>({normal:"#4CAF50",active_unacknowledged:"#F44336",active_acknowledged:"#FF9800",returned_to_normal_unacknowledged:"#FF9800",shelved:"#9C27B0",disabled:"#9E9E9E"}[t]??"#9E9E9E"),vt=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/alarm/list"})).alarms,ft=async t=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/channel/list"})).channels,yt=async(t,e={})=>(await t.connection.sendMessagePromise({type:"scada_alarm_manager/event/list",...e})).events,bt={0:"Info",1:"Warning",2:"High",3:"Critical"},$t={normal:"Normal",active_unacknowledged:"Active (Unacked)",active_acknowledged:"Active (Acked)",returned_to_normal_unacknowledged:"RTN (Unacked)",shelved:"Shelved",disabled:"Disabled"};let xt=class extends nt{constructor(){super(...arguments),this.priority=0}static{this.styles=o`
  ...
  `}render(){const t=gt(this.priority),e=bt[this.priority]??"Unknown";return F`
      <span class="badge" style="background-color: ${t}">${e}</span>
    `}};t([pt({type:Number})],xt.prototype,"priority",void 0),xt=t([ht("severity-badge")],xt);let wt=class extends nt{constructor(){super(...arguments),this._alarms=[],this._loading=!0,this._filterPriority="",this._filterName="",this._filterState="",this._filterSource=""}static{this.styles=[ut,o`
          ...
          <tr class="filter-row">
            <th>
              <select @change=${t=>this._filterPriority=t.target.value}>
                ...
                ${[0,1,2,3].map(t=>F`<option value=${t}>${bt[t]}</option>`)}
              </select>
            </th>
            ...
            <th>
              <select @change=${t=>this._filterState=t.target.value}>
                <option value="">All</option>
                ${["active_unacknowledged","active_acknowledged","returned_to_normal_unacknowledged"].map(t=>F`<option value=${t}>${$t[t]}</option>`)}
              </select>
            </th>
    ...
    `}};t([pt({attribute:!1})],wt.prototype,"hass",void 0),t([_t()],wt.prototype,"_alarms",void 0),t([_t()],wt.prototype,"_loading",void 0),t([_t()],wt.prototype,"_filterPriority",void 0),t([_t()],wt.prototype,"_filterName",void 0),t([_t()],wt.prototype,"_filterState",void 0),t([_t()],wt.prototype,"_filterSource",void 0),wt=t([ht("active-alarms-view")],wt);let At=class extends nt{constructor(){super(...arguments),this._alarms=[],this._channels=[],this._loading=!0,this._filterPriority="",this._filterName="",this._filterState="",this._filterEntity="",this._filterTrigger="",this._filterChannel="",this._filterEnabled=""}static{this.styles=[ut,o`
      :host { display: block; padding: 16px; }
        ...
        <thead>
          ...
          <tr class="filter-row">
            ...
            <th>
              <select @change=${t=>this._filterState=t.target.value}>
                <option value="">All</option>
                ${Object.entries($t).map(([t,e])=>F`<option value=${t}>${e}</option>`)}
              </select>
            </th>
    ...
    `}};t([pt({attribute:!1})],At.prototype,"hass",void 0),t([_t()],At.prototype,"_alarms",void 0),t([_t()],At.prototype,"_channels",void 0),t([_t()],At.prototype,"_loading",void 0),t([_t()],At.prototype,"_filterPriority",void 0),t([_t()],At.prototype,"_filterName",void 0),t([_t()],At.prototype,"_filterState",void 0),t([_t()],At.prototype,"_filterEntity",void 0),t([_t()],At.prototype,"_filterTrigger",void 0),t([_t()],At.prototype,"_filterChannel",void 0),t([_t()],At.prototype,"_filterEnabled",void 0),At=t([ht("all-alarms-view")],At);let kt=class extends nt{constructor(){super(...arguments),this._events=[],this._loading=!0,this._offset=0,this._limit=50,this._filterAlarm="",this._filterEvent="",this._filterUser=""}static{this.styles=[ut,o`
      :host { display: block; padding: 16px; }
    ...
    `}};t([pt({attribute:!1})],kt.prototype,"hass",void 0),t([_t()],kt.prototype,"_events",void 0),t([_t()],kt.prototype,"_loading",void 0),t([_t()],kt.prototype,"_offset",void 0),t([_t()],kt.prototype,"_filterAlarm",void 0),t([_t()],kt.prototype,"_filterEvent",void 0),t([_t()],kt.prototype,"_filterUser",void 0),kt=t([ht("history-view")],kt);let Ct=class extends nt{constructor(){super(...arguments),this._channels=[],this._loading=!0,this._editing=null,this._formName="",this._formTargets="",this._formMinPriority=0,this._formPersistent=!0,this._formMobile=!0,this._formCritical=!1,this._filterName=""}static{this.styles=[ut,o`
      :host { display: block; padding: 16px; }
      .form-card {
        background: var(--card-background-color, white);
        border: 1px solid var(--divider-color, #e0e0e0);
    ...
    `}};t([pt({attribute:!1})],Ct.prototype,"hass",void 0),t([_t()],Ct.prototype,"_channels",void 0),t([_t()],Ct.prototype,"_loading",void 0),t([_t()],Ct.prototype,"_editing",void 0),t([_t()],Ct.prototype,"_formName",void 0),t([_t()],Ct.prototype,"_formTargets",void 0),t([_t()],Ct.prototype,"_formMinPriority",void 0),t([_t()],Ct.prototype,"_formPersistent",void 0),t([_t()],Ct.prototype,"_formMobile",void 0),t([_t()],Ct.prototype,"_formCritical",void 0),t([_t()],Ct.prototype,"_filterName",void 0),Ct=t([ht("channels-view")],Ct);let Et=class extends nt{constructor(){super(...arguments),this._channels=[],this._loading=!0,this._saving=!1,this._name="",this._description="",this._sourceEntityId="",this._triggerType="digital",this._priority=1,this._area="",this._equipment="",this._tag="",this._channelId=null,this._enabled=!0,this._latching=!1,this._ackRequired=!0,this._autoClear=!0,this._analogOperator=">",this._analogThreshold="0",this._digitalTargetState="on",this._customMatchValues=""}static{this.styles=[ut,o`
    ...
    `}};t([pt({attribute:!1})],Et.prototype,"hass",void 0),t([pt()],Et.prototype,"alarmId",void 0),t([_t()],Et.prototype,"_channels",void 0),t([_t()],Et.prototype,"_loading",void 0),t([_t()],Et.prototype,"_saving",void 0),t([_t()],Et.prototype,"_name",void 0),t([_t()],Et.prototype,"_description",void 0),t([_t()],Et.prototype,"_sourceEntityId",void 0),t([_t()],Et.prototype,"_triggerType",void 0),t([_t()],Et.prototype,"_priority",void 0),t([_t()],Et.prototype,"_area",void 0),t([_t()],Et.prototype,"_equipment",void 0),t([_t()],Et.prototype,"_tag",void 0),t([_t()],Et.prototype,"_channelId",void 0),t([_t()],Et.prototype,"_enabled",void 0),t([_t()],Et.prototype,"_latching",void 0),t([_t()],Et.prototype,"_ackRequired",void 0),t([_t()],Et.prototype,"_autoClear",void 0),t([_t()],Et.prototype,"_analogOperator",void 0),t([_t()],Et.prototype,"_analogThreshold",void 0),t([_t()],Et.prototype,"_digitalTargetState",void 0),t([_t()],Et.prototype,"_customMatchValues",void 0),Et=t([ht("create-edit-view")],Et);let St=class extends nt{constructor(){super(...arguments),this._alarmCount=0,this._channelCount=0,this._eventCount=0,this._loading=!0}static{this.styles=[ut,o`
    ...
    `]}connectedCallback(){super.connectedCallback(),this._loadStats()}async _loadStats(){if(this.hass)try{const[t,e,i]=await Promise.all([vt(this.hass),ft(this.hass),yt(this.hass,{limit:1})]);this._alarmCount=t.length,this._channelCount=e.length,this._eventCount=i.length>0?-1:0}finally{this._loading=!1}}render(){return this._loading?F`<div class="empty-state">Loading...</div>`:F`
    ...
    `}};t([pt({attribute:!1})],St.prototype,"hass",void 0),t([_t()],St.prototype,"_alarmCount",void 0),t([_t()],St.prototype,"_channelCount",void 0),t([_t()],St.prototype,"_eventCount",void 0),t([_t()],St.prototype,"_loading",void 0),St=t([ht("settings-view")],St);const Pt=[{id:"active",label:"Active Alarms",icon:"🔴"},{id:"all",label:"All Alarms",icon:"📋"},{id:"history",label:"History",icon:"📜"},{id:"channels",label:"Channels",icon:"📡"},{id:"create-edit",label:"Create / Edit",icon:"✏️"},{id:"settings",label:"Settings",icon:"⚙️"}];let Tt=class extends nt{constructor(){super(...arguments),this._activeTab="active",this._handleNavigate=t=>{const{view:e,alarmId:i}=t.detail;this._activeTab=e,this._editAlarmId=i}}static{this.styles=[ut,o`
      :host {
        display: flex;
    ...
    `}_renderView(){switch(this._activeTab){case"active":default:return F`<active-alarms-view .hass=${this.hass}></active-alarms-view>`;case"all":return F`<all-alarms-view .hass=${this.hass}></all-alarms-view>`;case"history":return F`<history-view .hass=${this.hass}></history-view>`;case"channels":return F`<channels-view .hass=${this.hass}></channels-view>`;case"create-edit":return F`<create-edit-view .hass=${this.hass} .alarmId=${this._editAlarmId??""}></create-edit-view>`;case"settings":return F`<settings-view .hass=${this.hass}></settings-view>`}}};t([pt({attribute:!1})],Tt.prototype,"hass",void 0),t([pt({attribute:!1})],Tt.prototype,"panel",void 0),t([_t()],Tt.prototype,"_activeTab",void 0),t([_t()],Tt.prototype,"_editAlarmId",void 0),Tt=t([ht("scada-alarm-center-panel")],Tt);export{Tt as ScadaAlarmCenterPanel};
